...
par.dir_plus='stage2';
par.totaltime = 5;
par.dtime = 1.e-4; %t_c=3.8158e-04
...
par.mat_props=[2000,1.e8,0.3,10.e3,20,0.]; %n x p matrix, where n is the total number of material types
%1 elas 2 DP
par.mat_model=[2];  %n x 1 matrix, where n is the total number of material types
%% Computational mesh
load ans_soil_slope
par.space=[0.3]; %space for all bodies
% solid, body 1
...
monitor.ID=[213, 213, 213, 213, 213, 213, 213, 213];
