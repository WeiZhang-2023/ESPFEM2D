function  nFrd=force_rank_deficiency(par,nRNN,nRNs,nMat,nArea,nCoor,nVel,nF)
nFrd=zeros(par.node_cnt,2);
    ...
    for i = 1:nnode
        ...
        if(in~=curnode)
            ...
            if (lpij>1.e-12 && lpij0>1.e-12)
                ...
                f_hg=f_hg-0.5*par.rank_deficiency*xi_xj/lpij^2/lpij0^2*...
