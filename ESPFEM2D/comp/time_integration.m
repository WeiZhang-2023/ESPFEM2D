function [nVel,nDisp,nCoor]=time_integration(par,nMat,nArea,nBoundT,nBoundV,nVel,nDisp,nCoor,nFint,nFrd)
for in=1:par.node_cnt    
    ...
    for i=1:2
        ...
        if (type==1) %velocity boundary
            ...
            if (par.rank_deficiency>1.e-6) %hourglass control force
                force=force+nFrd(in,i);
            end
