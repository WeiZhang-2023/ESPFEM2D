...
if par.mesh_quality<par.remesh_thereshold %too distorted mesh
    par.if_remesh_now=1;
else
    par.if_remesh_now=0;
end
...
%% adjust remeshing thereshold
par=mesh_quality(par,eNode,nCoor);
par.remesh_thereshold=par.mesh_quality-par.remesh_quality_space;
if par.remesh_thereshold>par.max_remesh_thereshold
    par.remesh_thereshold=par.max_remesh_thereshold;
end
if par.remesh_thereshold<par.min_remesh_thereshold
    par.remesh_thereshold=par.min_remesh_thereshold;
    disp('Warning: min_remesh_thereshold has been reached!');
end
